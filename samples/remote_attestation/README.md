...
The host does the following in this sample:
   ...
   2. Ask enclave1 for a remote report and a public key, which is returned in a `RemoteReportWithPKey` structure.
      ...
      Where:
        ...
        - `pem_key` holds the public key that identifies enclave1 and will be used for establishing a secure communication channel between the enclave1 and the enclave2 once the attestation is done.
